...
public:
    ...
    Q_INVOKABLE  static QVariant readValueFromKey(const QString &key);
    Q_INVOKABLE  static QString getValue(const QString &index,const QString &key);
    Q_INVOKABLE  int sizeOfHash();
    static QHash<QString, QVariant> getIconInfoHash();
    ...
    Q_INVOKABLE void initIconInfo();

private:
    static QHash<QString,QVariant>m_iconInfoHash;
